      ...
      <div class="container-fluid">
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse ">
          <ul class="navbar-nav ml-auto d-lg-flex align-items-lg-center ">
            ...
            <li class="nav-item"><a href="{{route('sponsorgallery')}}" class="nav-link fs-5 font-weight-bold text-white  px-lg-3 py-lg-4">Gallery </a>
            </li>
            <li class="nav-item dropdown">
              ...
              <a href="{{route('sponsormammal')}}" class="dropdown-item small text-uppercase">Mammals</a>
              <a href="{{route('sponsorbird')}}" class="dropdown-item small text-uppercase">Birds</a>
              <a href="{{route('sponsorfish')}}" class="dropdown-item small text-uppercase">Fish</a>
              <a href="{{route('sponsorreptile')}}" class="dropdown-item small text-uppercase">Reptiles</a>
              <a href="{{route('sponsoramphibian')}}" class="dropdown-item small text-uppercase">Amphibians</a>
              </div>
            </li>
            <!-- show non sponsor only links -->
              ...
              <li class="nav-item"><a href="{{route('sponsortestimonial')}}" class="nav-link fs-5 font-weight-bold text-white px-lg-3 py-lg-4">Add Testimonial</a>
              </li>
              ...
              <li class="nav-item dropdown pr-2">
                ...
                <div class="dropdown-menu dropdown-menu-right rounded" style="background-image:linear-gradient(to right,white ,gray));">
                  <a href="{{route('logout')}}" class="dropdown-item">Logout</a>
                    ...
                    <a href="{{route('viewregsponsor')}}" class="dropdown-item">Update Profile</a>
