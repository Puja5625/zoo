                ...
                <div class="row justify-content-left mt-4">
                   ...
                   @foreach ($birds as $bird) 
                        <div class="col-xs-6 col-sm-6 col-md-4 col-xl-3 my-2">
                            <a href="{{route('birdinfo',$bird['id'])}}" class="product-class-link">
                                <div class="card product-card">
                                    <img src="../an_image/{{($bird['b_image'])}}" height="200px" title="Please click the card to see full information!" class="card-img-top animal-image-style" />
