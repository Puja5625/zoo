                ...
                <div class="mt-5">
                    ...
                    @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="date" class="form-control mb-3" id="date" value="0" name="t_date" required>
                            </div>
                        </div>
                        <div class="form-group row mt-4">
                            <div class="col-sm-10">

                                    <button type="submit" class="btn btn-primary btn-lg text_center w-100" name="submit">Book Ticket</button>
