                ...
                <div class="row justify-content-left mt-4">
                   ...
                   @foreach ($fishs as $fish) 
                        <div class="col-xs-6 col-sm-6 col-md-4 col-xl-3 my-2">
                            <a href="{{route('fishinfo',$fish['id'])}}" class="product-class-link">
                                <div class="card product-card">
                                    <img src="../an_image/{{($fish['f_image'])}}" height="200px" title="Please click the card to see full information!" class="card-img-top animal-image-style" />
